...
versionwarning_messages = {
    ...
    'issue-368-doc-version-warnings': 'You are viewing a development build of the canvasapi docs. <a href="/en/stable">Visit the stable release docs here.</a>',
...
htmlhelp_basename = 'canvasapidoc'
...
latex_documents = [
    (master_doc, 'canvasapi.tex', u'canvasapi Documentation',
...
man_pages = [
    (master_doc, 'canvasapi', u'canvasapi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'canvasapi', u'canvasapi Documentation',
     author, 'canvasapi', 'One line description of project.',
     'Miscellaneous'),
]
