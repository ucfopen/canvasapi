...
class TestContentExport(unittest.TestCase):
    def setUp(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            self.content_export_course = self.course.show_content_export(11)
            self.content_export_group = self.group.show_content_export(11)
            self.content_export_user = self.user.show_content_export(11)
